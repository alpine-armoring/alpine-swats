export default {
  ...
  availableNowSuvsURL: '/inventory/type/armored-suvs',
  availableNowSedansURL: '/inventory/type/armored-sedans',
  availableNowSpecialURL: '/inventory/type/special-of-the-month',
  availableNowTrucksURL: '/inventory/type/armored-pickup-trucks',
  availableNowLawURL: '/inventory/type/armored-law-enforcement',
  availableNowSpecialtyURL: '/inventory/type/armored-specialty-vehicles',
  preOwnedURL: '/inventory/type/armored-pre-owned',
  armoredRentalURL: 'armored-rental',
  rentalsURL: '/inventory/type/armored-rental',
  vehiclesWeArmorURL: '/models',
  suvsURL: '/models/type/armored-suvs',
  sedansURL: '/models/type/armored-sedans',
  specialtyURL: '/models/type/armored-specialty-vehicles',
  pickupTrucksURL: '/models/type/armored-pickup-trucks',
  lawEnforcementURL: '/models/type/armored-law-enforcement',
  vansURL: '/models/type/armored-vans-and-buses',
  citURL: '/models/type/armored-cash-in-transit-cit',
  aboutURL: '/about-us',
  newsURL: '/news',
  ...
  ballisticTestingURL: '/armored-vehicle-testing',
  faqsURL: '/faqs',
  ...
  ballisticTestingTitle: 'Armored Vehicle Testing',
